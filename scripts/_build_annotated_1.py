#!/usr/bin/env python3
"""Build annotated DOCX for proofread/1 files"""
...
with open('cache/issues_phase4_1.json', 'r', encoding='utf-8') as f:
...
# Write
os.makedirs('D:/translation/proofread/1/v1', exist_ok=True)
output = 'D:/translation/proofread/1/v1/[1]-CN_校对稿.docx'
