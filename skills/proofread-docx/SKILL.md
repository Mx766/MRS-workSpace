...
```bash
python ${SKILL_ROOT}/scripts/validate_phase4_output.py   --issues cache/issues_phase4.json   --verdict-sheet cache/phase3_verdict_sheet.json   --split-target cache/split_target.json   --phase3-issues cache/issues_mechanical.json   --output cache/phase4_validation_report.json
```
...
| V7 | issue 数量 | **0 issue 或 1 issue（>30段文档）→ AI 空跑，阻断** | v2.16 |
